...
parser.add_argument('--reward_path', type=str, default='./output_images_DQN/avg_reward.png')
parser.add_argument('--epsilon_path', type=str, default='./output_images_DQN/epsilon.png')
...
def main():
    ...
    create_directory(args.ckpt_dir, sub_dirs=['Q_net', 'Q_target'])
